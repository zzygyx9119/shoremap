...
#			print(paste("Analysing: ",outputpath, "/SHOREmap.winsize", winsize, ".txt", sep=""))
			...
			# Calc confidence interval
        	        ...
        	        ci<-ShoreMap.confint(ci_chromosome, ci_positions, ci_background_count, ci_forground_count, ci_error_count, foreground_frequency=target, level=0.999, recurse=F,forceInclude=T,allowAdjustment=0.05,filterOutliers=TRUE)
